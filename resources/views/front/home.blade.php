...
@section('content')
    <section class="relative h-[600px] flex items-center justify-center overflow-hidden mb-16">
        ...
        <div class="relative z-10 container mx-auto px-6 text-center text-white">
            ...
            <a href="{{ route('catalog') }}"
                class="inline-block bg-gradient-to-r from-primary to-indigo-600 text-white font-bold py-4 px-12 rounded-full hover:shadow-lg hover:shadow-indigo-500/50 transition transform hover:-translate-y-1 text-lg">
    ...
    <section class="container mx-auto px-6 lg:px-12 mb-24">
        <div
            ...
            <div class="w-full md:w-1/2">
                <span
                    class="text-primary font-bold tracking-wider uppercase text-sm bg-indigo-50 px-3 py-1 rounded-full">About Us</span>
                <h2 class="text-3xl font-bold text-slate-900 mt-4 mb-6">History of Utama Shop</h2>
                <p class="text-slate-600 text-lg leading-relaxed mb-6">
                    Usaha keluarga ini mulai berdiri pada tahun 1959. Berawal saat itu masih banyak petani palawija di
                    Karanganyar, Karangpandan, Jumapolo dan sekitarnya...
                </p>

                <button onclick="openModal()"
                    class="text-primary font-bold hover:text-indigo-800 flex items-center gap-2 group text-lg">
    ...
    <section class="container mx-auto px-6 lg:px-12 mb-24">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div
                class="bg-indigo-600 rounded-3xl p-10 text-white shadow-xl shadow-indigo-200 relative overflow-hidden group">
                <div
            ...
            <div
                class="bg-white rounded-3xl p-10 border border-slate-100 shadow-xl shadow-slate-200/50 relative overflow-hidden group">
                <div
                    class="absolute bottom-0 left-0 w-32 h-32 bg-primary opacity-5 rounded-full blur-2xl transform -translate-x-10 translate-y-10 group-hover:scale-150 transition duration-700">
                </div>
                <div class="relative z-10">
                    <div
                        class="w-14 h-14 bg-indigo-50 text-primary rounded-xl flex items-center justify-center text-3xl mb-6">
                        🚀
                    </div>
                    <h2 class="text-3xl font-bold text-slate-900 mb-4">Misi</h2>
                    <ul class="space-y-4">
                        <li class="flex items-start gap-3">
                            <span class="bg-green-100 text-green-600 rounded-full p-1 mt-1"><svg class="w-4 h-4"
    ...
    <section class="container mx-auto px-6 lg:px-12 mb-24">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div
                class="bg-white p-8 rounded-3xl shadow-lg shadow-slate-200/50 hover:shadow-xl hover:shadow-indigo-500/10 transition border border-slate-100 text-center group">
                <div
                    class="w-16 h-16 bg-indigo-100 text-primary rounded-2xl flex items-center justify-center mx-auto mb-6 text-3xl group-hover:scale-110 transition">
                    🤝
                </div>
                <h3 class="text-xl font-bold text-slate-900 mb-3">Pelayanan Kekeluargaan</h3>
                <p class="text-slate-600 leading-relaxed">
                    Dikenal pelayanannya yang baik karena pemilik (owner) ikut langsung melayani pembeli dengan sepenuh
                    hati.
                </p>
            </div>
            <div
            ...
            <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                <div class="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-2xl opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
                    ...
                    <div
                        ...
                        <p>Usaha keluarga ini mulai berdiri pada tahun <strong>1959</strong>. Berawal saat itu masih banyak
                            petani palawija di Karanganyar, Karangpandan, Jumapolo dan sekitarnya. Hasil pertanian adalah
                            beras, jagung, kedele, dan kacang hijau.</p>
                        <p><strong>Bp. Liem Kong Hong</strong> dan istrinya <strong>Ibu Meliati</strong> mengelola usaha
                            dengan menerima hasil pertanian tersebut dari Petani (semacam pengepul). Kemudian setelah
                            terkumpul cukup banyak kemudian dijual ke kota Solo, diangkut dengan pedati sapi.</p>
                        <p>Lokasi usaha awal di Selatan Pasar Karanganyar yang sekarang menjadi Taman Pancasila. Karena
                            dekat pasar dan pasar tersebut serta area terminal (tahun 1970-an) menjadi salah satu pusat
                            perekonomian Karanganyar, usaha mengalami peningkatan. Produk yang dijual mulai bervariasi
                            sesuai permintaan pasar seperti Minyak tanah, minyak goreng, tapioka, dan gandum.</p>
                        <p>Usaha ini banyak dikenal dengan nama <strong>"Toko Nyah Waing"</strong> (nama lain Ibu Meliati),
                            sampai sekarangpun terkadang pelanggan lama atau masyarakat asli Karanganyar menyebutnya
                            demikian.</p>
                        <p>Tahun 1982 Bp Liem Kong Hong meninggal dunia, bisnis usaha dipegang sepenuhnya oleh Ibu Meliati
                            dan dibantu putra putrinya (Ivan Purnomo dan Iin Salim). Seiring dengan berjalannya waktu dan
                            perubahan zaman, usaha inipun menjadi semacam toko grosiran sembako.</p>
                        <p>Oleh Bp. Ivan Purnomo usaha ini diberi nama/brand <strong>Toko Utama</strong>. Barang barang yang
                            dijualpun semakin bervariasi selain menyediakan 9 bahan pokok juga menyediakan barang barang
                            consumer good lainnya.</p>
                        <p>Di tahun 1990an permintaan produk rokok semakin meningkat, perputaran di barang dagangan ini
                            meningkat pesat sehingga produk rokok di toko ini mencapai 40% dari seluruh produk yang dijual.
                            Toko ini menjadi dikenal sebagai toko grosir rokok besar untuk wilayah Karanganyar sampai
                            sekarang.</p>
                        <div class="bg-indigo-50 p-4 rounded-xl border border-indigo-100 mt-4">
                            <h4 class="font-bold text-primary mb-2">Motto Kami:</h4>
                            <ul class="list-disc list-inside font-medium text-slate-700">
                                <li>Melayani dan untung bersama</li>
                                <li>Selalu baru dan lebih murah/miring harga</li>
                            </ul>
                        </div>
                    </div>
