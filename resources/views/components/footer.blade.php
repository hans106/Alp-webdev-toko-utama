        ...
        <div class="flex flex-col md:flex-row justify-between items-center md:items-start gap-8 mb-8">
            ...
            <div class="text-center md:text-right md:w-1/2">
                ...
                <button onclick="openWaModal()" 
                    class="inline-flex items-center gap-2 bg-green-600 hover:bg-green-500 text-white px-6 py-3 rounded-xl transition font-bold shadow-lg shadow-green-900/20 hover:-translate-y-1 transform duration-200">
