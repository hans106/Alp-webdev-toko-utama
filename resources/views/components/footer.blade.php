<footer class="bg-slate-900 text-slate-300 py-10 border-t border-slate-800 mt-auto">
    <div class="container mx-auto px-6 lg:px-12">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center md:items-start gap-8 mb-8">
            ...
            <div class="text-center md:text-left md:w-1/2">
                <a href="{{ route('home') }}" class="text-2xl font-extrabold text-white tracking-tight mb-4 inline-block">
                    Toko<span class="text-indigo-500">Utama</span>.
                </a>
                <p class="text-slate-400 text-sm leading-relaxed mb-4 max-w-md mx-auto md:mx-0">
            ...
            <div class="text-center md:text-right md:w-1/2">
                ...
                <p class="text-sm text-slate-400 mb-4">Hubungi Admin Keluarga kami langsung via WhatsApp.</p>
                
                <button onclick="openWaModal()" class="inline-flex items-center gap-2 bg-green-600 hover:bg-green-500 text-white px-6 py-3 rounded-xl transition font-bold shadow-lg shadow-green-900/20 hover:-translate-y-1 transform duration-200">
    ...
    <div id="waModalFooter" class="fixed inset-0 z-[100] hidden" role="dialog" aria-modal="true">
        <div class="fixed inset-0 bg-slate-900/80 backdrop-blur-sm transition-opacity opacity-0" id="waBackdrop" onclick="closeWaModal()"></div>
