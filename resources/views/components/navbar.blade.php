            ...
            <a href="{{ route('cart.index') }}" 
               class="relative text-amber-200 hover:text-amber-400 transition group">
                <svg xmlns="http://www.w3.org/2000/svg" 
                     class="h-6 w-6 group-hover:scale-110 transition" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            @auth
                <div class="relative group">
                    <button class="font-semibold text-amber-200 hover:text-amber-400 flex items-center gap-2 transition">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-amber-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                    </button>

                    <div class="absolute right-0 mt-4 w-48 bg-white rounded-xl shadow-xl py-2 opacity-0 
