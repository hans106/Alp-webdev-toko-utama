...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        <div>
            ...
            <p class="text-gray-500 text-sm">Dashboard Admin / Supplier & Distributor</p>
        </div>
        
        <a href="{{ route('admin.suppliers.create') }}" class="bg-blue-600 text-white px-6 py-2 rounded-xl hover:bg-blue-700 transition font-bold shadow-lg flex items-center gap-2">
    ...
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 mb-8">
        <form action="{{ route('admin.suppliers.index') }}" method="GET">
            <div class="flex gap-4 items-end">
                ...
                <button type="submit" class="bg-gray-800 text-white px-6 py-2 rounded-xl font-bold hover:bg-gray-900 transition">
                    Cari
                </button>
            </div>
        </form>
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 text-sm font-medium">
                            <div class="flex gap-2">
                                {{-- Tombol VIEW --}}
                                <a href="{{ route('admin.suppliers.show', $supplier) }}" class="text-blue-600 hover:text-blue-900 bg-blue-50 px-3 py-1 rounded-md transition">Lihat</a>
                                
                                {{-- Tombol EDIT --}}
                                <a href="{{ route('admin.suppliers.edit', $supplier) }}" class="text-indigo-600 hover:text-indigo-900 bg-indigo-50 px-3 py-1 rounded-md transition">Edit</a>
