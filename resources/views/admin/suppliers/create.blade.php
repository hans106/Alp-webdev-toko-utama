...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-500 text-sm">Dashboard Admin / Supplier & Distributor / Tambah</p>
    </div>
        ...
        <form action="{{ route('admin.suppliers.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <textarea id="address" name="address" rows="4" 
                    ...
                    class="w-full px-4 py-2 border rounded-lg focus:ring-blue-500 focus:border-blue-500 @error('address') border-red-500 @enderror">{{ old('address') }}</textarea>
                @error('address')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('admin.suppliers.index') }}" class="bg-gray-200 text-gray-700 px-6 py-2 rounded-lg font-bold hover:bg-gray-300 transition">
                    Batal
                </a>
            </div>
        </form>
