...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
        <div class="bg-primary px-8 py-4">
            ...
            <p class="text-primary-100 text-sm">Isi formulir di bawah ini dengan lengkap.</p>
        </div>
        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="p-8">
            @csrf <div class="mb-6">
                ...
                <input type="text" name="name" class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-primary focus:border-primary transition" placeholder="Contoh: Indomie Goreng Jumbo" required>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    <label class="block text-gray-700 font-bold mb-2">Kategori <span class="text-red-500">*</span></label>
                    <select name="category_id" class="w-full border border-gray-300 rounded-xl px-4 py-3 bg-white focus:ring-2 focus:ring-primary-500" required>
                ...
                <div>
                    ...
                    <select name="brand_id" class="w-full border border-gray-300 rounded-xl px-4 py-3 bg-white focus:ring-2 focus:ring-primary-500" required>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="price" class="w-full border border-gray-300 rounded-xl pl-10 pr-4 py-3 focus:ring-2 focus:ring-primary" placeholder="0" required>
                    </div>
                </div>
                <div>
                    <label class="block text-gray-700 font-bold mb-2">Stok Awal <span class="text-red-500">*</span></label>
                    <input type="number" name="stock" class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-primary-500" placeholder="0" required>
                </div>
            </div>

            <div class="mb-6">
                <label class="block text-gray-700 font-bold mb-2">Deskripsi Produk <span class="text-red-500">*</span></label>
                <textarea name="description" rows="4" class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-primary-500" placeholder="Jelaskan detail produk..." required></textarea>
            </div>
            ...
            <div class="mb-8">
                ...
                <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:bg-gray-50 transition cursor-pointer relative">
                    ...
                    <div class="text-gray-500">
                        ...
                        <span class="font-medium text-primary">Klik untuk upload</span> atau drag gambar ke sini
            ...
            <div class="flex items-center justify-end">
                <button type="submit" class="bg-primary text-white font-bold py-3 px-8 rounded-xl hover:bg-primary-700 transition shadow-lg transform hover:scale-105">
                    Simpan Produk
                </button>
            </div>
